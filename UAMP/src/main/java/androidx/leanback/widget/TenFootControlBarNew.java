 ...
 */
public class TenFootControlBarNew extends ControlBar {
     ...
     * {@inheritDoc}
     */
    public TenFootControlBarNew(Context context, AttributeSet attrs) {
     ...
     * {@inheritDoc}
     */
    public TenFootControlBarNew(Context context, AttributeSet attrs, int defStyle) {
