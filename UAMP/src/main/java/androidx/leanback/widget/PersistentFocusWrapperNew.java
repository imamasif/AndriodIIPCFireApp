 ...
 */
public class PersistentFocusWrapperNew extends FrameLayout {
    ...
    public PersistentFocusWrapperNew(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public PersistentFocusWrapperNew(Context context, AttributeSet attrs, int defStyle) {
